...
double CG_decoder_first_order_continuous (int L, double physical_error, double measu_error, int time, int precision, double tau) {
...
/////////////////////////////////////////// GET MATCHING GRAPH AND PERFECT MATCHING
		...
		vector<long double> degeneracy(n_blocks);	// First-order degeneracy parameter
